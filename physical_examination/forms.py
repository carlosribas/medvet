...
class ExaminationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'body_condition': Select(attrs={'class': 'form-control'}, choices=BODY_CONDITION),
            'attitude': Select(attrs={'class': 'form-control'}, choices=ATTITUDE_ANSWER),
            ...
            'hydration': Select(attrs={'class': 'form-control'}, choices=DEHYDRATED_ANSWER),
            'mouth': RadioSelect(choices=DEFAULT_ANSWER),
            'mouth_note': TextInput(attrs={'class': 'form-control'}),
            'mucous_membrane': Select(attrs={'class': 'form-control'}, choices=MUCOUS_ANSWER),
