...
class Animal(models.Model):
    ...
    color = models.ForeignKey(Color, verbose_name=_('Color'), blank=True, null=True)
    fur = models.CharField(_('Fur'), max_length=1, choices=FUR_ANSWER, blank=True, default=None)
    ...
    sex = models.CharField(_('Sex'), max_length=1, choices=SEX_ANSWER, blank=True)
    spay_neuter = models.CharField(_('Spay or Neuter'), max_length=1, choices=YES_NO_ANSWER, blank=True)
    spay_neuter_date = models.CharField(_('When?'), max_length=100, blank=True)
    microchip = models.CharField(_('Microchip'), max_length=50, blank=True)
    dead = models.CharField(_('Dead'), max_length=1, choices=YES_NO_ANSWER, blank=True, default=NO)
