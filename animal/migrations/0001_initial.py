    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fur', models.CharField(blank=True, choices=[(b'l', 'Long'), (b's', 'Short')], default=None, max_length=1, null=True, verbose_name='Fur')),
                ...
                ('dead', models.CharField(blank=True, choices=[(b'n', 'No'), (b'y', 'Yes')], max_length=1, null=True, verbose_name='Dead')),
