# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-06-20 18:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fur', models.CharField(blank=True, choices=[(b'long', 'Long'), (b'short', 'Short')], default=None, max_length=5)),
                ('animal_name', models.CharField(max_length=100)),
                ('birthdate', models.DateField(blank=True, null=True, validators=[animal.models.validate_date_birth])),
                ('sex', models.CharField(blank=True, choices=[(b'male', 'Male'), (b'female', 'Female')], max_length=6)),
                ('spay_neuter', models.CharField(blank=True, choices=[(b'no', 'No'), (b'yes', 'Yes')], max_length=3)),
                ('spay_neuter_date', models.CharField(blank=True, max_length=100)),
                ('microchip', models.CharField(blank=True, max_length=50)),
                ('dead', models.CharField(blank=True, choices=[(b'no', 'No'), (b'yes', 'Yes')], default=b'no', max_length=3)),
