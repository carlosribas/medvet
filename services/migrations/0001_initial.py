...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('service_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='services.Service')),
                ('exam_type', models.CharField(choices=[('collect', 'Collecting material for request of exams'), ('request', 'Request of exam'), ('annex', 'Attach exam')], default=True, max_length=10)),
